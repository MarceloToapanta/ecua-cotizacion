...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { approved: @quotation.approved, date: @quotation.date, date_approved: @quotation.date_approved, description: @quotation.description, published: @quotation.published, user_appoved_id: @quotation.user_appoved_id }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { approved: @quotation.approved, date: @quotation.date, date_approved: @quotation.date_approved, description: @quotation.description, published: @quotation.published, user_appoved_id: @quotation.user_appoved_id }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
